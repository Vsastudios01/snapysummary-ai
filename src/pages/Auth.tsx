          ...
          <Tabs defaultValue={defaultTab}>
            ...
            <TabsContent value="login">
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button type="button" className="w-full text-sm text-primary hover:underline">Forgot password?</button>
              </form>
            </TabsContent>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="signup-name" placeholder="Your name" className="pl-9" />
                  </div>
                </div>
                <div className="space-y-2">
